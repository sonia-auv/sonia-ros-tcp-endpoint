...
![Docker Image CI - Master Branch](https://github.com/sonia-auv/sonia-ros-tcp-endpoint/workflows/Docker%20Image%20CI%20-%20Master%20Branch/badge.svg)
![Docker Image CI - Develop Branch](https://github.com/sonia-auv/sonia-ros-tcp-endpoint/workflows/Docker%20Image%20CI%20-%20Develop%20Branch/badge.svg?branch=develop)
![GitHub release (latest by date)](https://img.shields.io/github/v/release/sonia-auv/sonia-ros-tcp-endpoint)
![Average time to resolve an issue](https://isitmaintained.com/badge/resolution/sonia-auv/sonia-ros-tcp-endpoint.svg)
...
```bash
    git clone git@github.com:sonia-auv/sonia-ros-tcp-endpoint.git
```
